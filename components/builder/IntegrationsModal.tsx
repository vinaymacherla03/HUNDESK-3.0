...
const IntegrationItem: React.FC<{ 
    ...
    onToggle?: () => void;
    actionText?: string;
}> = ({ icon, title, description, connected = false, onToggle, actionText = "Connect" }) => (
...
const LinkedInIcon = () => (
     <div className="w-12 h-12 rounded-xl bg-[#0077b5] shadow-md shadow-blue-200 flex items-center justify-center p-2.5">
            ...
            >
                ...
                <div className="p-6 space-y-4 max-h-[70vh] overflow-y-auto custom-scrollbar bg-slate-50/30">
                    ...
                    <IntegrationItem 
                        ...
                        description="Connect your account to import job details and contacts with one click."
                    ...
                    <IntegrationItem 
                        ...
                        description="Automatically sync application statuses from supported job boards."
