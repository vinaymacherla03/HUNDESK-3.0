    ...
    return (
        <div>
            ...
            {(data.experience || []).map((exp, index) => (
                <FormSection key={exp.id || index} title={exp.role || `Experience #${index + 1}`} onRemove={() => handleRemove(index)}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-4">
                     ...
                     <div className="mb-4">
                        <label className="block text-sm font-medium text-slate-600 mb-1.5">Description (Achievements & Responsibilities)</label>
