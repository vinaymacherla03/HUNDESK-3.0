...
const FlowProfessionalTemplate: React.FC<TemplateProps> = ({ data, sectionOrder, customization, sectionVisibility, onDataChange }) => {
  ...
  const sectionTitleStyles: React.CSSProperties = {
    // Re-added sectionTitleBorderStyle: 'underline' || sectionTitleBorderStyle: 'full' to the sectionTitleStyles
    fontSize: `${sectionTitleSize}pt`,
    color: sectionTitleColor,
    textTransform: sectionTitleUppercase ? 'uppercase' : 'none',
    letterSpacing: '0.05em',
    paddingBottom: '0.15rem',
    borderBottom: `2px solid ${sectionTitleBorderColor}`,
  };
  ...
  return (
    <div id="resume-content" style={{ padding: marginValue }}>
      <header className="text-center mb-8 pb-4 border-b-2 border-[var(--primary-color-light)]">
...
export default FlowProfessionalTemplate;
