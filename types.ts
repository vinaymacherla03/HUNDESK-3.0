export type TemplateKey = 'json-flat' | 'flow-simple' | 'flow-modern' | 'flow-professional';
export type ResumeSectionKey = 'summary' | 'experience' | 'projects' | 'education' | 'certifications' | 'skills' | 'awards';

export type ColorTheme = 'indigo' | 'blue' | 'emerald' | 'rose' | 'slate' | 'orange' | 'amber';
export type FontTheme = 'inter' | 'roboto' | 'lato' | 'montserrat' | 'source-sans' | 'lora' | 'roboto-mono';
